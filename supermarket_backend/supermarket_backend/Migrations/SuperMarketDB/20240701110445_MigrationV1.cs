        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RowDelete = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    FetureProduct = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Attribute_Products", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Attribute_Products_Attributes_AttributeId",
                        column: x => x.AttributeId,
                        principalTable: "Attributes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Attribute_Products_Products_ProductId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Attribute_Products_AttributeId",
                table: "Attribute_Products",
                column: "AttributeId");

            migrationBuilder.CreateIndex(
                name: "IX_Attribute_Products_ProductId",
                table: "Attribute_Products",
                column: "ProductId");
